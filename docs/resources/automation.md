...
- `observed_count` (Number) Observed execution count in the period at trip time.
- `period` (String) Snapshot of the period at trip time.
- `threshold` (Number) Snapshot of the threshold at trip time.
- `tripped_at` (String)
