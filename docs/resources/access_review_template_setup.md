...
page_title: "conductorone_access_review_template_setup Resource - terraform-provider-conductorone"
subcategory: ""
description: |-
  AccessReviewTemplateSetup Resource
---

# conductorone_access_review_template_setup (Resource)
...
```terraform
import {
  to = conductorone_access_review_template_setup.my_conductorone_access_review_template_setup
  id = "..."
}
```
