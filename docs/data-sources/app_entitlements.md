...
<a id="nestedatt--list--app_entitlement--deprovisioner_policy--device_placement_provision"></a>
### Nested Schema for `list.app_entitlement.deprovisioner_policy.device_placement_provision`
...
- `device_placement_provision` (Attributes) This provision step is fulfilled by a Latchkey member device producing an MLS Welcome for the recipient. It has no assignee and no instructions because the step is not human-actionable. (see [below for nested schema](#nestedatt--list--app_entitlement--provision_policy--device_placement_provision))
...
<a id="nestedatt--list--app_entitlement--provision_policy--device_placement_provision"></a>
### Nested Schema for `list.app_entitlement.provision_policy.device_placement_provision`
