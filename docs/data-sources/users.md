...
- `user_actor_object_permissions` (Attributes) ActorObjectPermissions describes which actions the calling user is permitted to perform on an object, as determined by policy. (see [below for nested schema](#nestedatt--list--user_actor_object_permissions))
...
<a id="nestedatt--list--user_actor_object_permissions"></a>
### Nested Schema for `list.user_actor_object_permissions`
