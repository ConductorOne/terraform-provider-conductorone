...
This message contains a oneof named target. Only a single field of the following list may be set at a time:
  - automation (see [below for nested schema](#nestedatt--list--policy_steps--steps--action))
...
- `action_target_automation` (Attributes) The ActionTargetAutomation message. (see [below for nested schema](#nestedatt--list--policy_steps--steps--action--action_target_automation))
