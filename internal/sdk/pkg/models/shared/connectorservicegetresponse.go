...
type _ConnectorServiceGetResponseExpanded ConnectorServiceGetResponseExpanded

func (c *ConnectorServiceGetResponseExpanded) UnmarshalJSON(bs []byte) error {
	data := _ConnectorServiceGetResponseExpanded{}

	if err := json.Unmarshal(bs, &data); err != nil {
		return err
	}
	*c = ConnectorServiceGetResponseExpanded(data)
...
func (c ConnectorServiceGetResponseExpanded) MarshalJSON() ([]byte, error) {
	...
	bs, err := json.Marshal(_ConnectorServiceGetResponseExpanded(c))
	if err != nil {
		return nil, err
	}
