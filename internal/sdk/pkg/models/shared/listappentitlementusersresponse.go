...
type _ListAppEntitlementUsersResponseExpanded ListAppEntitlementUsersResponseExpanded

func (c *ListAppEntitlementUsersResponseExpanded) UnmarshalJSON(bs []byte) error {
	data := _ListAppEntitlementUsersResponseExpanded{}

	if err := json.Unmarshal(bs, &data); err != nil {
		return err
	}
	*c = ListAppEntitlementUsersResponseExpanded(data)
...
func (c ListAppEntitlementUsersResponseExpanded) MarshalJSON() ([]byte, error) {
	...
	bs, err := json.Marshal(_ListAppEntitlementUsersResponseExpanded(c))
	if err != nil {
		return nil, err
	}
