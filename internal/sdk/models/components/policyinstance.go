...
type PolicyInstance struct {
	...
	Next []PolicyStep1 `json:"next,omitempty"`
	// A policy describes the behavior of the ConductorOne system when processing a task. You can describe the type, approvers, fallback behavior, and escalation processes.
	Policy *Policy1 `json:"policy,omitempty"`
}
...
func (o *PolicyInstance) GetNext() []PolicyStep1 {
	if o == nil {
		return nil
	}
	return o.Next
...
func (o *PolicyInstance) GetPolicy() *Policy1 {
	if o == nil {
		return nil
	}
	return o.Policy
