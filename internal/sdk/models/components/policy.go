...
// Policy1 - A policy describes the behavior of the ConductorOne system when processing a task. You can describe the type, approvers, fallback behavior, and escalation processes.
type Policy1 struct {
	CreatedAt *time.Time `json:"createdAt,omitempty"`
	DeletedAt *time.Time `json:"deletedAt,omitempty"`
	// The description of the Policy.
	...
	ID *string `json:"id,omitempty"`
	// A map of string(policy type) to steps in a policy. This structure is leftover from a previous design, and should only ever have one key->value set.
	PolicySteps map[string]PolicySteps1 `json:"policySteps,omitempty"`
	// Indicates the type of this policy. Can also be used to get the value from policySteps.
	PolicyType *PolicyType `json:"policyType,omitempty"`
	// An array of actions (ordered) to take place after a policy completes processing.
	PostActions []PolicyPostActions `json:"postActions,omitempty"`
...
func (p Policy1) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(p, "", false)
}

func (p *Policy1) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &p, "", false, false); err != nil {
		return err
	}
	return nil
...
func (o *Policy1) GetCreatedAt() *time.Time {
	if o == nil {
		return nil
	}
	return o.CreatedAt
...
func (o *Policy1) GetDeletedAt() *time.Time {
	if o == nil {
		return nil
	}
	return o.DeletedAt
...
func (o *Policy1) GetDescription() *string {
	if o == nil {
		return nil
	}
	return o.Description
...
func (o *Policy1) GetDisplayName() *string {
	if o == nil {
		return nil
	}
	return o.DisplayName
...
func (o *Policy1) GetPolicySteps() map[string]PolicySteps1 {
	if o == nil {
		return nil
	}
	return o.PolicySteps
...
func (o *Policy1) GetPolicyType() *PolicyType {
	if o == nil {
		return nil
	}
	return o.PolicyType
...
func (o *Policy1) GetPostActions() []PolicyPostActions {
	if o == nil {
		return nil
	}
	return o.PostActions
...
func (o *Policy1) GetReassignTasksToDelegates() *bool {
	if o == nil {
		return nil
	}
	return o.ReassignTasksToDelegates
...
func (o *Policy1) GetSystemBuiltin() *bool {
	if o == nil {
		return nil
	}
	return o.SystemBuiltin
...
func (o *Policy1) GetUpdatedAt() *time.Time {
	if o == nil {
		return nil
	}
	return o.UpdatedAt
