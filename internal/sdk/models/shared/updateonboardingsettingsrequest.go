...
type UpdateOnboardingSettingsRequest struct {
	...
	McpOnboardingTargetList *McpOnboardingTargetList `json:"mcpOnboardingTargets,omitempty"`
...
func (u *UpdateOnboardingSettingsRequest) GetMcpOnboardingTargetList() *McpOnboardingTargetList {
	if u == nil {
		return nil
	}
	return u.McpOnboardingTargetList
}
