...
func (p *PaperSecretServiceSearchMySecretsRequest) GetSecretType() *SecretType {
	if p == nil {
		return nil
	}
	return p.SecretType
...
func (p *PaperSecretServiceSearchMySecretsRequest) GetSharingMode() *SharingMode {
	if p == nil {
		return nil
	}
...
func (p *PaperSecretServiceSearchMySecretsRequest) GetSortBy() *SortBy {
	if p == nil {
		return nil
	}
	return p.SortBy
...
func (p *PaperSecretServiceSearchMySecretsRequest) GetStatuses() []Statuses {
	if p == nil {
		return nil
	}
	return p.Statuses
