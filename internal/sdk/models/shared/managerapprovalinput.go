...
func (m *ManagerApprovalInput) GetFallbackGroupIds() []AppEntitlementReference {
	if m == nil {
		return nil
	}
...
func (m *ManagerApprovalInput) GetIsGroupFallbackEnabled() *bool {
	if m == nil {
		return nil
	}
