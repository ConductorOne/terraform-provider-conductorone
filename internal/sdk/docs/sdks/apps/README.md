...
func main() {
    ...
    res, err := s.Apps.Create(ctx, shared.CreateAppRequest{
        CertifyPolicyID: conductoronesdkterraform.String("esse"),
        Description: conductoronesdkterraform.String("harum"),
        DisplayName: conductoronesdkterraform.String("iusto"),
        GrantPolicyID: conductoronesdkterraform.String("ipsum"),
        MonthlyCostUsd: conductoronesdkterraform.Int(788740),
        Owners: []string{
            "amet",
            "tempore",
            "accusamus",
...
func main() {
    ...
    res, err := s.Apps.List(ctx, operations.C1APIAppV1AppsListRequest{
        PageSize: conductoronesdkterraform.Int(16429),
        PageToken: conductoronesdkterraform.String("quas"),
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Apps.Update(ctx, operations.C1APIAppV1AppsUpdateRequest{
        UpdateAppRequestInput: &shared.UpdateAppRequestInput{
            App: &shared.AppInput{
                CertifyPolicyID: conductoronesdkterraform.String("itaque"),
                Description: conductoronesdkterraform.String("consequatur"),
                DisplayName: conductoronesdkterraform.String("est"),
                GrantPolicyID: conductoronesdkterraform.String("repellendus"),
                IconURL: conductoronesdkterraform.String("porro"),
                IdentityMatching: shared.AppIdentityMatchingAppUserIdentityMatchingDisplayName.ToPointer(),
                MonthlyCostUsd: conductoronesdkterraform.Int(281730),
                RevokePolicyID: conductoronesdkterraform.String("facilis"),
            },
            UpdateMask: conductoronesdkterraform.String("cupiditate"),
        },
