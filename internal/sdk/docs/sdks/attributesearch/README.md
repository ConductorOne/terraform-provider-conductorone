...
| `request`                                                                                          | [components.SearchAttributeValuesRequest](../../models/components/searchattributevaluesrequest.md) | :heavy_check_mark:                                                                                 | The request object to use for the request.                                                         |
