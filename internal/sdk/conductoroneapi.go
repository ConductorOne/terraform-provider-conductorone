...
func New(opts ...SDKOption) *ConductoroneAPI {
	sdk := &ConductoroneAPI{
		SDKVersion: "1.1.6",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/terraform 1.1.6 2.882.0 0.1.0-alpha github.com/conductorone/terraform-provider-conductorone/internal/sdk",
