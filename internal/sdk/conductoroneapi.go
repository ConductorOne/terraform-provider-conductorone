...
// Generated from OpenAPI doc version 0.1.0-alpha and generator version 2.884.4
...
func New(opts ...SDKOption) *ConductoroneAPI {
	sdk := &ConductoroneAPI{
		SDKVersion: "1.3.1",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/terraform 1.3.1 2.884.4 0.1.0-alpha github.com/conductorone/terraform-provider-conductorone/internal/sdk",
