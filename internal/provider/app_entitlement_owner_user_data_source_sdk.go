...
func (r *AppEntitlementOwnerUserDataSourceModel) RefreshFromSharedAppEntitlementOwnerUser(ctx context.Context, resp *shared.AppEntitlementOwnerUser) diag.Diagnostics {
...
func (r *AppEntitlementOwnerUserDataSourceModel) RefreshFromSharedSearchAppEntitlementUserOwnersResponse(ctx context.Context, resp *shared.SearchAppEntitlementUserOwnersResponse) diag.Diagnostics {
	var diags diag.Diagnostics
	...
	if resp != nil {
		...
		diags.Append(r.RefreshFromSharedAppEntitlementOwnerUser(ctx, &resp.List[0])...)
...
func (r *AppEntitlementOwnerUserDataSourceModel) ToOperationsC1APIAppV2AppEntitlementOwnersSearchUserOwnersRequest(ctx context.Context) (*operations.C1APIAppV2AppEntitlementOwnersSearchUserOwnersRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	out := operations.C1APIAppV2AppEntitlementOwnersSearchUserOwnersRequest{
		AppID:         appID,
