...
func (r *IntegrationDocusignResourceModel) ToCreateSDKType() *shared.ConnectorServiceCreateDelegatedRequest {
...
func (r *IntegrationDocusignResourceModel) ToUpdateSDKType() *shared.Connector {
	userIds := make([]string, 0)
	for _, userIdsItem := range r.UserIds {
		userIds = append(userIds, userIdsItem.ValueString())
	}
