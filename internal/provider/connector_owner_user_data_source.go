...
var _ datasource.DataSource = &ConnectorOwnerUserDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectorOwnerUserDataSource{}

func NewConnectorOwnerUserDataSource() datasource.DataSource {
	return &ConnectorOwnerUserDataSource{}
}

// ConnectorOwnerUserDataSource is the data source implementation.
type ConnectorOwnerUserDataSource struct {
	// Provider configured SDK client.
	client *sdk.ConductoroneAPI
}

// ConnectorOwnerUserDataSourceModel describes the data model.
type ConnectorOwnerUserDataSourceModel struct {
...
func (r *ConnectorOwnerUserDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connector_owner_user"
}

// Schema defines the schema for the data source.
func (r *ConnectorOwnerUserDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectorOwnerUser DataSource",
...
func (r *ConnectorOwnerUserDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectorOwnerUserDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectorOwnerUserDataSourceModel
	...
	request, requestDiags := data.ToOperationsC1APIAppV2ConnectorOwnersSearchUserOwnersRequest(ctx)
	resp.Diagnostics.Append(requestDiags...)

	if resp.Diagnostics.HasError() {
		return
	}
	res, err := r.client.ConnectorOwnersV2.SearchUserOwners(ctx, *request)
	if err != nil {
	...
	resp.Diagnostics.Append(data.RefreshFromSharedSearchConnectorUserOwnersResponse(ctx, res.SearchConnectorUserOwnersResponse)...)
