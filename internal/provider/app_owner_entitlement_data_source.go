...
var _ datasource.DataSource = &AppOwnerEntitlementDataSource{}
var _ datasource.DataSourceWithConfigure = &AppOwnerEntitlementDataSource{}

func NewAppOwnerEntitlementDataSource() datasource.DataSource {
	return &AppOwnerEntitlementDataSource{}
}

// AppOwnerEntitlementDataSource is the data source implementation.
type AppOwnerEntitlementDataSource struct {
	// Provider configured SDK client.
	client *sdk.ConductoroneAPI
}

// AppOwnerEntitlementDataSourceModel describes the data model.
type AppOwnerEntitlementDataSourceModel struct {
...
func (r *AppOwnerEntitlementDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_app_owner_entitlement"
}

// Schema defines the schema for the data source.
func (r *AppOwnerEntitlementDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "AppOwnerEntitlement DataSource",
...
func (r *AppOwnerEntitlementDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *AppOwnerEntitlementDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *AppOwnerEntitlementDataSourceModel
	...
	request, requestDiags := data.ToOperationsC1APIAppV2AppOwnersSearchEntitlementOwnersRequest(ctx)
	resp.Diagnostics.Append(requestDiags...)

	if resp.Diagnostics.HasError() {
		return
	}
	res, err := r.client.AppOwnersV2.SearchEntitlementOwners(ctx, *request)
	if err != nil {
