...
func (r *TaskRevokeResourceModel) RefreshFromSharedTaskServiceCreateRevokeResponse(ctx context.Context, resp *shared.TaskServiceCreateRevokeResponse) diag.Diagnostics {
...
func (r *TaskRevokeResourceModel) ToSharedTaskServiceCreateRevokeRequest(ctx context.Context) (*shared.TaskServiceCreateRevokeRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	out := shared.TaskServiceCreateRevokeRequest{
