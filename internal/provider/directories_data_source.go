...
var _ datasource.DataSourceWithConfigure = &DirectoriesDataSource{}

func NewDirectoriesDataSource() datasource.DataSource {
	return &DirectoriesDataSource{}
}

// DirectoriesDataSource is the data source implementation.
type DirectoriesDataSource struct {
	// Provider configured SDK client.
	client *sdk.ConductoroneAPI
}

// DirectoriesDataSourceModel describes the data model.
...
func (r *DirectoriesDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_directories"
}

// Schema defines the schema for the data source.
func (r *DirectoriesDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Directories DataSource",
...
func (r *DirectoriesDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *DirectoriesDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
