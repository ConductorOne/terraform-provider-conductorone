...
func (p *ConductoroneProvider) Resources(ctx context.Context) []func() resource.Resource {
	resources := []func() resource.Resource{
		...
		NewAppEntitlementOwnerEntitlementResource,
		NewAppEntitlementOwnerUserResource,
		NewAppOwnerResource,
		NewAppOwnerEntitlementResource,
		NewAppOwnerUserResource,
		NewConnectorOwnerEntitlementResource,
		...
		NewRecoveryPolicyResource,
		NewCredentialInventoryPolicyResource,
		NewAppResourceOwnerUserResource,
		NewAppResourceOwnerEntitlementResource,
		NewWebhookResource,
...
func (p *ConductoroneProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		NewSignInPolicyDataSource,
		NewRecoveryPolicyDataSource,
		NewCredentialInventoryPolicyDataSource,
		NewAppResourceOwnerUserDataSource,
		NewAppResourceOwnerEntitlementDataSource,
		NewAccessReviewTemplateSetupDataSource,
		NewAccessProfileDataSource,
		NewAppDataSource,
		NewAppEntitlementProxyBindingDataSource,
		NewAppEntitlementOwnerEntitlementDataSource,
		NewAppEntitlementOwnerUserDataSource,
		NewAppOwnerEntitlementDataSource,
		NewAppOwnerUserDataSource,
		NewConnectorOwnerEntitlementDataSource,
		NewConnectorOwnerUserDataSource,
