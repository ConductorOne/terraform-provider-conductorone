...
func (r *ConnectorOwnerUserDataSourceModel) RefreshFromSharedConnectorOwnerUser(ctx context.Context, resp *shared.ConnectorOwnerUser) diag.Diagnostics {
...
func (r *ConnectorOwnerUserDataSourceModel) RefreshFromSharedSearchConnectorUserOwnersResponse(ctx context.Context, resp *shared.SearchConnectorUserOwnersResponse) diag.Diagnostics {
	var diags diag.Diagnostics
	...
	if resp != nil {
		...
		diags.Append(r.RefreshFromSharedConnectorOwnerUser(ctx, &resp.List[0])...)
...
func (r *ConnectorOwnerUserDataSourceModel) ToOperationsC1APIAppV2ConnectorOwnersSearchUserOwnersRequest(ctx context.Context) (*operations.C1APIAppV2ConnectorOwnersSearchUserOwnersRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	out := operations.C1APIAppV2ConnectorOwnersSearchUserOwnersRequest{
		AppID:       appID,
