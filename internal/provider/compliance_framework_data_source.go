...
var _ datasource.DataSource = &ComplianceFrameworkDataSource{}
var _ datasource.DataSourceWithConfigure = &ComplianceFrameworkDataSource{}
...
// ComplianceFrameworkDataSourceModel describes the data model.
...
func (r *ComplianceFrameworkDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ComplianceFramework DataSource",
