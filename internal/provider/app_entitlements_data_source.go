...
var _ datasource.DataSource = &AppEntitlementsDataSource{}
var _ datasource.DataSourceWithConfigure = &AppEntitlementsDataSource{}

func NewAppEntitlementsDataSource() datasource.DataSource {
	return &AppEntitlementsDataSource{}
}
...
type AppEntitlementsDataSourceModel struct {
	...
	Facets                  *tfTypes.Facets              `tfsdk:"facets"`
...
func (r *AppEntitlementsDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_app_entitlements"
}

// Schema defines the schema for the data source.
func (r *AppEntitlementsDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "AppEntitlements DataSource",
		...
		Attributes: map[string]schema.Attribute{
			...
			"facets": schema.SingleNestedAttribute{
				Computed: true,
				Attributes: map[string]schema.Attribute{
...
func (r *AppEntitlementsDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *AppEntitlementsDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *AppEntitlementsDataSourceModel
