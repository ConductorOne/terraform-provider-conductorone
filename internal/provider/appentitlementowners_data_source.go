...
var _ datasource.DataSource = &AppEntitlementOwnersDataSource{}
var _ datasource.DataSourceWithConfigure = &AppEntitlementOwnersDataSource{}

func NewAppEntitlementOwnersDataSource() datasource.DataSource {
	return &AppEntitlementOwnersDataSource{}
}

// AppEntitlementOwnersDataSource is the data source implementation.
type AppEntitlementOwnersDataSource struct {
	// Provider configured SDK client.
	client *sdk.ConductoroneAPI
}

// AppEntitlementOwnersDataSourceModel describes the data model.
type AppEntitlementOwnersDataSourceModel struct {
...
func (r *AppEntitlementOwnersDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_app_entitlement_owners"
}

// Schema defines the schema for the data source.
func (r *AppEntitlementOwnersDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "AppEntitlementOwners DataSource",
...
func (r *AppEntitlementOwnersDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *AppEntitlementOwnersDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *AppEntitlementOwnersDataSourceModel
	...
	request, requestDiags := data.ToOperationsC1APIAppV1AppEntitlementOwnersListRequest(ctx)
	resp.Diagnostics.Append(requestDiags...)

	if resp.Diagnostics.HasError() {
		return
	}
	res, err := r.client.AppEntitlementOwners.List(ctx, *request)
	if err != nil {
	...
	resp.Diagnostics.Append(data.RefreshFromSharedListAppEntitlementOwnersResponse(ctx, res.ListAppEntitlementOwnersResponse)...)
