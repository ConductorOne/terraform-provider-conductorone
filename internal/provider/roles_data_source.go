			...
			"list": schema.ListNestedAttribute{
				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"system_api_only": schema.BoolAttribute{
							Computed:    true,
							Description: `This Role is intended for API keys usage only, and the user interface may not function as expected.`,
						},
						"system_builtin": schema.BoolAttribute{
							Computed:    true,
							Description: `The system builtin field. If this field is set, the role is not editable.`,
						},
...
func (r *RolesDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	request, requestDiags := data.ToOperationsC1APIIamV1RolesListRequest(ctx)
	resp.Diagnostics.Append(requestDiags...)

	if resp.Diagnostics.HasError() {
		return
	}
	res, err := r.client.Roles.List(ctx, *request)
	if err != nil {
	...
	resp.Diagnostics.Append(data.RefreshFromSharedListRolesResponse(ctx, res.ListRolesResponse)...)
