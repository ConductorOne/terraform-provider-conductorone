...
var _ datasource.DataSource = &AppEntitlementOwnerEntitlementDataSource{}
var _ datasource.DataSourceWithConfigure = &AppEntitlementOwnerEntitlementDataSource{}

func NewAppEntitlementOwnerEntitlementDataSource() datasource.DataSource {
	return &AppEntitlementOwnerEntitlementDataSource{}
}

// AppEntitlementOwnerEntitlementDataSource is the data source implementation.
type AppEntitlementOwnerEntitlementDataSource struct {
	// Provider configured SDK client.
	client *sdk.ConductoroneAPI
}

// AppEntitlementOwnerEntitlementDataSourceModel describes the data model.
type AppEntitlementOwnerEntitlementDataSourceModel struct {
	...
	RoleSlug       types.String            `queryParam:"style=form,explode=true,name=role_slug" tfsdk:"role_slug"`
}

// Metadata returns the data source type name.
func (r *AppEntitlementOwnerEntitlementDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_app_entitlement_owner_entitlement"
}

// Schema defines the schema for the data source.
func (r *AppEntitlementOwnerEntitlementDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "AppEntitlementOwnerEntitlement DataSource",
...
func (r *AppEntitlementOwnerEntitlementDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *AppEntitlementOwnerEntitlementDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *AppEntitlementOwnerEntitlementDataSourceModel
	...
	request, requestDiags := data.ToOperationsC1APIAppV2AppEntitlementOwnersSearchEntitlementOwnersRequest(ctx)
	resp.Diagnostics.Append(requestDiags...)

	if resp.Diagnostics.HasError() {
		return
	}
	res, err := r.client.AppEntitlementOwnersV2.SearchEntitlementOwners(ctx, *request)
	if err != nil {
	...
	resp.Diagnostics.Append(data.RefreshFromSharedSearchAppEntitlementEntitlementOwnersResponse(ctx, res.SearchAppEntitlementEntitlementOwnersResponse)...)
