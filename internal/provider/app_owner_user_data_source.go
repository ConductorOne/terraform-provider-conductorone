...
var _ datasource.DataSource = &AppOwnerUserDataSource{}
var _ datasource.DataSourceWithConfigure = &AppOwnerUserDataSource{}

func NewAppOwnerUserDataSource() datasource.DataSource {
	return &AppOwnerUserDataSource{}
}

// AppOwnerUserDataSource is the data source implementation.
type AppOwnerUserDataSource struct {
	// Provider configured SDK client.
	client *sdk.ConductoroneAPI
}

// AppOwnerUserDataSourceModel describes the data model.
type AppOwnerUserDataSourceModel struct {
...
func (r *AppOwnerUserDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_app_owner_user"
}

// Schema defines the schema for the data source.
func (r *AppOwnerUserDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "AppOwnerUser DataSource",
...
func (r *AppOwnerUserDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *AppOwnerUserDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *AppOwnerUserDataSourceModel
	...
	request, requestDiags := data.ToOperationsC1APIAppV2AppOwnersSearchUserOwnersRequest(ctx)
	resp.Diagnostics.Append(requestDiags...)

	if resp.Diagnostics.HasError() {
		return
	}
	res, err := r.client.AppOwnersV2.SearchUserOwners(ctx, *request)
	if err != nil {
	...
	resp.Diagnostics.Append(data.RefreshFromSharedSearchAppUserOwnersResponse(ctx, res.SearchAppUserOwnersResponse)...)
