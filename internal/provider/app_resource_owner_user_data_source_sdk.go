...
func (r *AppResourceOwnerUserDataSourceModel) RefreshFromSharedAppResourceOwnerUser(ctx context.Context, resp *shared.AppResourceOwnerUser) diag.Diagnostics {
...
func (r *AppResourceOwnerUserDataSourceModel) RefreshFromSharedSearchAppResourceUserOwnersResponse(ctx context.Context, resp *shared.SearchAppResourceUserOwnersResponse) diag.Diagnostics {
	var diags diag.Diagnostics
	...
	if resp != nil {
		...
		diags.Append(r.RefreshFromSharedAppResourceOwnerUser(ctx, &resp.List[0])...)
...
func (r *AppResourceOwnerUserDataSourceModel) ToOperationsC1APIAppV2AppResourceOwnersV2SearchUserOwnersRequest(ctx context.Context) (*operations.C1APIAppV2AppResourceOwnersV2SearchUserOwnersRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	out := operations.C1APIAppV2AppResourceOwnersV2SearchUserOwnersRequest{
		AppID:          appID,
