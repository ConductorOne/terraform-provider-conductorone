...
func (r *RolesDataSourceModel) RefreshFromSharedListRolesResponse(ctx context.Context, resp *shared.ListRolesResponse) diag.Diagnostics {
...
func (r *RolesDataSourceModel) ToOperationsC1APIIamV1RolesListRequest(ctx context.Context) (*operations.C1APIIamV1RolesListRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
