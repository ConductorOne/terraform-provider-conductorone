...
var _ datasource.DataSource = &AppEntitlementOwnerUserDataSource{}
var _ datasource.DataSourceWithConfigure = &AppEntitlementOwnerUserDataSource{}

func NewAppEntitlementOwnerUserDataSource() datasource.DataSource {
	return &AppEntitlementOwnerUserDataSource{}
}

// AppEntitlementOwnerUserDataSource is the data source implementation.
type AppEntitlementOwnerUserDataSource struct {
	// Provider configured SDK client.
	client *sdk.ConductoroneAPI
}

// AppEntitlementOwnerUserDataSourceModel describes the data model.
type AppEntitlementOwnerUserDataSourceModel struct {
...
func (r *AppEntitlementOwnerUserDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_app_entitlement_owner_user"
}

// Schema defines the schema for the data source.
func (r *AppEntitlementOwnerUserDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "AppEntitlementOwnerUser DataSource",
...
func (r *AppEntitlementOwnerUserDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *AppEntitlementOwnerUserDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *AppEntitlementOwnerUserDataSourceModel
	...
	request, requestDiags := data.ToOperationsC1APIAppV2AppEntitlementOwnersSearchUserOwnersRequest(ctx)
	resp.Diagnostics.Append(requestDiags...)

	if resp.Diagnostics.HasError() {
		return
	}
	res, err := r.client.AppEntitlementOwnersV2.SearchUserOwners(ctx, *request)
	if err != nil {
	...
	resp.Diagnostics.Append(data.RefreshFromSharedSearchAppEntitlementUserOwnersResponse(ctx, res.SearchAppEntitlementUserOwnersResponse)...)
