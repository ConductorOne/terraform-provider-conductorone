...
var _ datasource.DataSource = &AppResourceOwnerEntitlementDataSource{}
var _ datasource.DataSourceWithConfigure = &AppResourceOwnerEntitlementDataSource{}

func NewAppResourceOwnerEntitlementDataSource() datasource.DataSource {
	return &AppResourceOwnerEntitlementDataSource{}
}

// AppResourceOwnerEntitlementDataSource is the data source implementation.
type AppResourceOwnerEntitlementDataSource struct {
	// Provider configured SDK client.
	client *sdk.ConductoroneAPI
}

// AppResourceOwnerEntitlementDataSourceModel describes the data model.
type AppResourceOwnerEntitlementDataSourceModel struct {
...
func (r *AppResourceOwnerEntitlementDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_app_resource_owner_entitlement"
}

// Schema defines the schema for the data source.
func (r *AppResourceOwnerEntitlementDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "AppResourceOwnerEntitlement DataSource",
...
func (r *AppResourceOwnerEntitlementDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *AppResourceOwnerEntitlementDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *AppResourceOwnerEntitlementDataSourceModel
	...
	request, requestDiags := data.ToOperationsC1APIAppV2AppResourceOwnersV2SearchEntitlementOwnersRequest(ctx)
	resp.Diagnostics.Append(requestDiags...)

	if resp.Diagnostics.HasError() {
		return
	}
	res, err := r.client.AppResourceOwnersV2.SearchEntitlementOwners(ctx, *request)
	if err != nil {
	...
	resp.Diagnostics.Append(data.RefreshFromSharedSearchAppResourceEntitlementOwnersResponse(ctx, res.SearchAppResourceEntitlementOwnersResponse)...)
