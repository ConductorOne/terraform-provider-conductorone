...
var _ datasource.DataSource = &AccessReviewSetupDataSource{}
var _ datasource.DataSourceWithConfigure = &AccessReviewSetupDataSource{}

func NewAccessReviewSetupDataSource() datasource.DataSource {
	return &AccessReviewSetupDataSource{}
}

// AccessReviewSetupDataSource is the data source implementation.
type AccessReviewSetupDataSource struct {
	// Provider configured SDK client.
	client *sdk.ConductoroneAPI
}

// AccessReviewSetupDataSourceModel describes the data model.
type AccessReviewSetupDataSourceModel struct {
...
func (r *AccessReviewSetupDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_access_review_setup"
}

// Schema defines the schema for the data source.
func (r *AccessReviewSetupDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "AccessReviewSetup DataSource",
...
func (r *AccessReviewSetupDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *AccessReviewSetupDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *AccessReviewSetupDataSourceModel
