...
func (r *AppEntitlementOwnersDataSourceModel) RefreshFromSharedListAppEntitlementOwnersResponse(ctx context.Context, resp *shared.ListAppEntitlementOwnersResponse) diag.Diagnostics {
...
func (r *AppEntitlementOwnersDataSourceModel) ToOperationsC1APIAppV1AppEntitlementOwnersListRequest(ctx context.Context) (*operations.C1APIAppV1AppEntitlementOwnersListRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	out := operations.C1APIAppV1AppEntitlementOwnersListRequest{
		AppID:         appID,
