...
var _ datasource.DataSource = &RiskLevelDataSource{}
var _ datasource.DataSourceWithConfigure = &RiskLevelDataSource{}
...
// RiskLevelDataSourceModel describes the data model.
...
func (r *RiskLevelDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "RiskLevel DataSource",
...
func (r *RiskLevelDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *RiskLevelDataSourceModel
