...
var _ datasource.DataSource = &AppResourceOwnerUserDataSource{}
var _ datasource.DataSourceWithConfigure = &AppResourceOwnerUserDataSource{}

func NewAppResourceOwnerUserDataSource() datasource.DataSource {
	return &AppResourceOwnerUserDataSource{}
}

// AppResourceOwnerUserDataSource is the data source implementation.
type AppResourceOwnerUserDataSource struct {
	// Provider configured SDK client.
	client *sdk.ConductoroneAPI
}

// AppResourceOwnerUserDataSourceModel describes the data model.
type AppResourceOwnerUserDataSourceModel struct {
...
func (r *AppResourceOwnerUserDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_app_resource_owner_user"
}

// Schema defines the schema for the data source.
func (r *AppResourceOwnerUserDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "AppResourceOwnerUser DataSource",
...
func (r *AppResourceOwnerUserDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *AppResourceOwnerUserDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *AppResourceOwnerUserDataSourceModel
	...
	request, requestDiags := data.ToOperationsC1APIAppV2AppResourceOwnersV2SearchUserOwnersRequest(ctx)
	resp.Diagnostics.Append(requestDiags...)

	if resp.Diagnostics.HasError() {
		return
	}
	res, err := r.client.AppResourceOwnersV2.SearchUserOwners(ctx, *request)
	if err != nil {
	...
	resp.Diagnostics.Append(data.RefreshFromSharedSearchAppResourceUserOwnersResponse(ctx, res.SearchAppResourceUserOwnersResponse)...)
