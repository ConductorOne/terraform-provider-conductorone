...
func (r *AppEntitlementResourceModel) ToUpdateSDKType() *shared.AppEntitlementInput {
	...
	var provisionPolicy *shared.AppEntitlementProvisionPolicy
	if r.ProvisionPolicy != nil {
			...
			if r.ProvisionPolicy.ManualProvision.ProvisionerAssignment != nil {
				...
				if r.ProvisionPolicy.ManualProvision.ProvisionerAssignment.AppOwnerProvisioner != nil {
					...
					if r.ProvisionPolicy.ManualProvision.ProvisionerAssignment.AppOwnerProvisioner.FallbackUserIds != nil {
						...
						for _, fallbackUserIdsItem := range r.ProvisionPolicy.ManualProvision.ProvisionerAssignment.AppOwnerProvisioner.FallbackUserIds {
				...
				if r.ProvisionPolicy.ManualProvision.ProvisionerAssignment.EntitlementOwnerProvisioner != nil {
					...
					if r.ProvisionPolicy.ManualProvision.ProvisionerAssignment.EntitlementOwnerProvisioner.FallbackUserIds != nil {
						...
						for _, fallbackUserIdsItem1 := range r.ProvisionPolicy.ManualProvision.ProvisionerAssignment.EntitlementOwnerProvisioner.FallbackUserIds {
				...
				if r.ProvisionPolicy.ManualProvision.ProvisionerAssignment.ExpressionProvisioner != nil {
					...
					if r.ProvisionPolicy.ManualProvision.ProvisionerAssignment.ExpressionProvisioner.Expressions != nil {
						...
						for _, expressionsItem := range r.ProvisionPolicy.ManualProvision.ProvisionerAssignment.ExpressionProvisioner.Expressions {
					...
					if r.ProvisionPolicy.ManualProvision.ProvisionerAssignment.ExpressionProvisioner.FallbackUserIds != nil {
						...
						for _, fallbackUserIdsItem2 := range r.ProvisionPolicy.ManualProvision.ProvisionerAssignment.ExpressionProvisioner.FallbackUserIds {
				...
				if r.ProvisionPolicy.ManualProvision.ProvisionerAssignment.GroupProvisioner != nil {
					...
					if !r.ProvisionPolicy.ManualProvision.ProvisionerAssignment.GroupProvisioner.AppID.IsUnknown() && !r.ProvisionPolicy.ManualProvision.ProvisionerAssignment.GroupProvisioner.AppID.IsNull() {
						*appId4 = r.ProvisionPolicy.ManualProvision.ProvisionerAssignment.GroupProvisioner.AppID.ValueString()
					} else {
						appId4 = nil
					}
					...
					if r.ProvisionPolicy.ManualProvision.ProvisionerAssignment.GroupProvisioner.FallbackUserIds != nil {
						...
						for _, fallbackUserIdsItem3 := range r.ProvisionPolicy.ManualProvision.ProvisionerAssignment.GroupProvisioner.FallbackUserIds {
				...
				if r.ProvisionPolicy.ManualProvision.ProvisionerAssignment.ManagerProvisioner != nil {
					...
					if r.ProvisionPolicy.ManualProvision.ProvisionerAssignment.ManagerProvisioner.FallbackUserIds != nil {
						...
						for _, fallbackUserIdsItem4 := range r.ProvisionPolicy.ManualProvision.ProvisionerAssignment.ManagerProvisioner.FallbackUserIds {
				...
				if r.ProvisionPolicy.ManualProvision.ProvisionerAssignment.UserProvisioner != nil {
					...
					if r.ProvisionPolicy.ManualProvision.ProvisionerAssignment.UserProvisioner.UserIds != nil {
						...
						for _, userProvisionerUserIdsItem := range r.ProvisionPolicy.ManualProvision.ProvisionerAssignment.UserProvisioner.UserIds {
							userProvisionerUserIds = append(userProvisionerUserIds, userProvisionerUserIdsItem.ValueString())
						}
					}
		...
		provisionPolicy = &shared.AppEntitlementProvisionPolicy{
	...
	if r.DeprovisionerPolicy != nil {
		...
		if r.DeprovisionerPolicy.ManualProvision != nil {
			...
			if r.DeprovisionerPolicy.ManualProvision.ProvisionerAssignment != nil {
				...
				if r.DeprovisionerPolicy.ManualProvision.ProvisionerAssignment.AppOwnerProvisioner != nil {
					...
					if r.DeprovisionerPolicy.ManualProvision.ProvisionerAssignment.AppOwnerProvisioner.FallbackUserIds != nil {
						...
						for _, fallbackUserIdsItem5 := range r.DeprovisionerPolicy.ManualProvision.ProvisionerAssignment.AppOwnerProvisioner.FallbackUserIds {
				...
				if r.DeprovisionerPolicy.ManualProvision.ProvisionerAssignment.EntitlementOwnerProvisioner != nil {
					...
					if r.DeprovisionerPolicy.ManualProvision.ProvisionerAssignment.EntitlementOwnerProvisioner.FallbackUserIds != nil {
						...
						for _, fallbackUserIdsItem6 := range r.DeprovisionerPolicy.ManualProvision.ProvisionerAssignment.EntitlementOwnerProvisioner.FallbackUserIds {
							fallbackUserIds6 = append(fallbackUserIds6, fallbackUserIdsItem6.ValueString())
						}
					}
				...
				if r.DeprovisionerPolicy.ManualProvision.ProvisionerAssignment.ExpressionProvisioner != nil {
					...
					if r.DeprovisionerPolicy.ManualProvision.ProvisionerAssignment.ExpressionProvisioner.Expressions != nil {
						...
						for _, expressionsItem1 := range r.DeprovisionerPolicy.ManualProvision.ProvisionerAssignment.ExpressionProvisioner.Expressions {
							expressions1 = append(expressions1, expressionsItem1.ValueString())
						}
					}
					...
					if r.DeprovisionerPolicy.ManualProvision.ProvisionerAssignment.ExpressionProvisioner.FallbackUserIds != nil {
						...
						for _, fallbackUserIdsItem7 := range r.DeprovisionerPolicy.ManualProvision.ProvisionerAssignment.ExpressionProvisioner.FallbackUserIds {
							fallbackUserIds7 = append(fallbackUserIds7, fallbackUserIdsItem7.ValueString())
						}
					}
				...
				if r.DeprovisionerPolicy.ManualProvision.ProvisionerAssignment.GroupProvisioner != nil {
					...
					if !r.DeprovisionerPolicy.ManualProvision.ProvisionerAssignment.GroupProvisioner.AppID.IsUnknown() && !r.DeprovisionerPolicy.ManualProvision.ProvisionerAssignment.GroupProvisioner.AppID.IsNull() {
						*appId7 = r.DeprovisionerPolicy.ManualProvision.ProvisionerAssignment.GroupProvisioner.AppID.ValueString()
					} else {
						appId7 = nil
					}
					...
					if r.DeprovisionerPolicy.ManualProvision.ProvisionerAssignment.GroupProvisioner.FallbackUserIds != nil {
						...
						for _, fallbackUserIdsItem8 := range r.DeprovisionerPolicy.ManualProvision.ProvisionerAssignment.GroupProvisioner.FallbackUserIds {
							fallbackUserIds8 = append(fallbackUserIds8, fallbackUserIdsItem8.ValueString())
						}
					}
				...
				if r.DeprovisionerPolicy.ManualProvision.ProvisionerAssignment.ManagerProvisioner != nil {
					...
					if r.DeprovisionerPolicy.ManualProvision.ProvisionerAssignment.ManagerProvisioner.FallbackUserIds != nil {
						...
						for _, fallbackUserIdsItem9 := range r.DeprovisionerPolicy.ManualProvision.ProvisionerAssignment.ManagerProvisioner.FallbackUserIds {
							fallbackUserIds9 = append(fallbackUserIds9, fallbackUserIdsItem9.ValueString())
						}
					}
				...
				if r.DeprovisionerPolicy.ManualProvision.ProvisionerAssignment.UserProvisioner != nil {
					...
					if r.DeprovisionerPolicy.ManualProvision.ProvisionerAssignment.UserProvisioner.UserIds != nil {
						...
						for _, userProvisionerUserIdsItem1 := range r.DeprovisionerPolicy.ManualProvision.ProvisionerAssignment.UserProvisioner.UserIds {
							userProvisionerUserIds1 = append(userProvisionerUserIds1, userProvisionerUserIdsItem1.ValueString())
						}
					}
				...
				provisionerAssignment1 = &shared.ProvisionerAssignment{
					AppOwners:         appOwnerProvisioner1,
					EntitlementOwners: entitlementOwnerProvisioner1,
					Expression:        expressionProvisioner1,
					Group:             groupProvisioner1,
					Manager:           managerProvisioner1,
					Users:             userProvisioner1,
				}
			}
			...
			manualProvision1 = &shared.ManualProvision{
				Assignee:     provisionerAssignment1,
		...
		deprovisionerPolicy = &shared.DeprovisionerPolicy{
			Action:         actionProvision1,
			Connector:      connectorProvision1,
			Delegated:      delegatedProvision1,
			ExternalTicket: externalTicketProvision1,
			Manual:         manualProvision1,
			MultiStep:      multiStep1,
			Unconfigured:   unconfiguredProvision1,
			Webhook:        webhookProvision1,
		}
	}
...
func (r *AppEntitlementResourceModel) RefreshFromGetResponse(resp *shared.AppEntitlement) {
	if resp != nil {
		...
		if resp.DeprovisionerPolicy == nil {
			...
			r.DeprovisionerPolicy = &tfTypes.AppEntitlementResourceProvisionPolicy{}
			if resp.DeprovisionerPolicy.Action == nil {
				...
				r.DeprovisionerPolicy.ActionProvision.ActionName = types.StringPointerValue(resp.DeprovisionerPolicy.Action.ActionName)
				r.DeprovisionerPolicy.ActionProvision.AppID = types.StringPointerValue(resp.DeprovisionerPolicy.Action.AppID)
				r.DeprovisionerPolicy.ActionProvision.ConnectorID = types.StringPointerValue(resp.DeprovisionerPolicy.Action.ConnectorID)
			}
			if resp.DeprovisionerPolicy.Connector == nil {
				r.DeprovisionerPolicy.ConnectorProvision = nil
			} else {
				r.DeprovisionerPolicy.ConnectorProvision = &tfTypes.AppEntitlementConnectorProvision{}
				if resp.DeprovisionerPolicy.Connector.Account == nil {
					...
					r.DeprovisionerPolicy.ConnectorProvision.AccountProvision.ConnectorID = types.StringPointerValue(resp.DeprovisionerPolicy.Connector.Account.ConnectorID)
					...
					if resp.DeprovisionerPolicy.Connector.Account.SaveToVault == nil {
						...
						if resp.DeprovisionerPolicy.Connector.Account.SaveToVault.VaultIds != nil {
							r.DeprovisionerPolicy.ConnectorProvision.AccountProvision.SaveToVault.VaultIds = make([]types.String, 0, len(resp.DeprovisionerPolicy.Connector.Account.SaveToVault.VaultIds))
					...
					r.DeprovisionerPolicy.ConnectorProvision.AccountProvision.SchemaID = types.StringPointerValue(resp.DeprovisionerPolicy.Connector.Account.SchemaID)
				}
				if resp.DeprovisionerPolicy.Connector.DefaultBehavior == nil {
					...
					r.DeprovisionerPolicy.ConnectorProvision.DefaultBehavior.ConnectorID = types.StringPointerValue(resp.DeprovisionerPolicy.Connector.DefaultBehavior.ConnectorID)
				}
				if resp.DeprovisionerPolicy.Connector.DeleteAccount == nil {
					...
					r.DeprovisionerPolicy.ConnectorProvision.DeleteAccount.ConnectorID = types.StringPointerValue(resp.DeprovisionerPolicy.Connector.DeleteAccount.ConnectorID)
				}
			}
			if resp.DeprovisionerPolicy.Delegated == nil {
				...
				r.DeprovisionerPolicy.DelegatedProvision.AppID = types.StringPointerValue(resp.DeprovisionerPolicy.Delegated.AppID)
				r.DeprovisionerPolicy.DelegatedProvision.EntitlementID = types.StringPointerValue(resp.DeprovisionerPolicy.Delegated.EntitlementID)
			}
			if resp.DeprovisionerPolicy.ExternalTicket == nil {
				...
				r.DeprovisionerPolicy.ExternalTicketProvision.AppID = types.StringPointerValue(resp.DeprovisionerPolicy.ExternalTicket.AppID)
				r.DeprovisionerPolicy.ExternalTicketProvision.ConnectorID = types.StringPointerValue(resp.DeprovisionerPolicy.ExternalTicket.ConnectorID)
				r.DeprovisionerPolicy.ExternalTicketProvision.ExternalTicketProvisionerConfigID = types.StringPointerValue(resp.DeprovisionerPolicy.ExternalTicket.ExternalTicketProvisionerConfigID)
				r.DeprovisionerPolicy.ExternalTicketProvision.Instructions = types.StringPointerValue(resp.DeprovisionerPolicy.ExternalTicket.Instructions)
			}
			if resp.DeprovisionerPolicy.Manual == nil {
				r.DeprovisionerPolicy.ManualProvision = nil
			} else {
				r.DeprovisionerPolicy.ManualProvision = &tfTypes.AppEntitlementManualProvision{}
				r.DeprovisionerPolicy.ManualProvision.Instructions = types.StringPointerValue(resp.DeprovisionerPolicy.Manual.Instructions)
				if resp.DeprovisionerPolicy.Manual.Assignee == nil {
					r.DeprovisionerPolicy.ManualProvision.ProvisionerAssignment = nil
				} else {
					r.DeprovisionerPolicy.ManualProvision.ProvisionerAssignment = &tfTypes.AppEntitlementProvisionerAssignment{}
					if resp.DeprovisionerPolicy.Manual.Assignee.AppOwners == nil {
						...
						r.DeprovisionerPolicy.ManualProvision.ProvisionerAssignment.AppOwnerProvisioner.AllowReassignment = types.BoolPointerValue(resp.DeprovisionerPolicy.Manual.Assignee.AppOwners.AllowReassignment)
						if resp.DeprovisionerPolicy.Manual.Assignee.AppOwners.FallbackUserIds != nil {
							r.DeprovisionerPolicy.ManualProvision.ProvisionerAssignment.AppOwnerProvisioner.FallbackUserIds = make([]types.String, 0, len(resp.DeprovisionerPolicy.Manual.Assignee.AppOwners.FallbackUserIds))
					...
					if resp.DeprovisionerPolicy.Manual.Assignee.EntitlementOwners == nil {
						...
						r.DeprovisionerPolicy.ManualProvision.ProvisionerAssignment.EntitlementOwnerProvisioner.AllowReassignment = types.BoolPointerValue(resp.DeprovisionerPolicy.Manual.Assignee.EntitlementOwners.AllowReassignment)
						if resp.DeprovisionerPolicy.Manual.Assignee.EntitlementOwners.FallbackUserIds != nil {
							r.DeprovisionerPolicy.ManualProvision.ProvisionerAssignment.EntitlementOwnerProvisioner.FallbackUserIds = make([]types.String, 0, len(resp.DeprovisionerPolicy.Manual.Assignee.EntitlementOwners.FallbackUserIds))
					...
					if resp.DeprovisionerPolicy.Manual.Assignee.Expression == nil {
						...
						r.DeprovisionerPolicy.ManualProvision.ProvisionerAssignment.ExpressionProvisioner.AllowReassignment = types.BoolPointerValue(resp.DeprovisionerPolicy.Manual.Assignee.Expression.AllowReassignment)
						if resp.DeprovisionerPolicy.Manual.Assignee.Expression.Expressions != nil {
							r.DeprovisionerPolicy.ManualProvision.ProvisionerAssignment.ExpressionProvisioner.Expressions = make([]types.String, 0, len(resp.DeprovisionerPolicy.Manual.Assignee.Expression.Expressions))
						...
						if resp.DeprovisionerPolicy.Manual.Assignee.Expression.FallbackUserIds != nil {
							r.DeprovisionerPolicy.ManualProvision.ProvisionerAssignment.ExpressionProvisioner.FallbackUserIds = make([]types.String, 0, len(resp.DeprovisionerPolicy.Manual.Assignee.Expression.FallbackUserIds))
					...
					if resp.DeprovisionerPolicy.Manual.Assignee.Group == nil {
						...
						r.DeprovisionerPolicy.ManualProvision.ProvisionerAssignment.GroupProvisioner.AllowReassignment = types.BoolPointerValue(resp.DeprovisionerPolicy.Manual.Assignee.Group.AllowReassignment)
						r.DeprovisionerPolicy.ManualProvision.ProvisionerAssignment.GroupProvisioner.AppGroupID = types.StringPointerValue(resp.DeprovisionerPolicy.Manual.Assignee.Group.AppGroupID)
						r.DeprovisionerPolicy.ManualProvision.ProvisionerAssignment.GroupProvisioner.AppID = types.StringPointerValue(resp.DeprovisionerPolicy.Manual.Assignee.Group.AppID)
						if resp.DeprovisionerPolicy.Manual.Assignee.Group.FallbackUserIds != nil {
							r.DeprovisionerPolicy.ManualProvision.ProvisionerAssignment.GroupProvisioner.FallbackUserIds = make([]types.String, 0, len(resp.DeprovisionerPolicy.Manual.Assignee.Group.FallbackUserIds))
					...
					if resp.DeprovisionerPolicy.Manual.Assignee.Manager == nil {
						...
						r.DeprovisionerPolicy.ManualProvision.ProvisionerAssignment.ManagerProvisioner.AllowReassignment = types.BoolPointerValue(resp.DeprovisionerPolicy.Manual.Assignee.Manager.AllowReassignment)
						if resp.DeprovisionerPolicy.Manual.Assignee.Manager.FallbackUserIds != nil {
							r.DeprovisionerPolicy.ManualProvision.ProvisionerAssignment.ManagerProvisioner.FallbackUserIds = make([]types.String, 0, len(resp.DeprovisionerPolicy.Manual.Assignee.Manager.FallbackUserIds))
					...
					if resp.DeprovisionerPolicy.Manual.Assignee.Users == nil {
						...
						r.DeprovisionerPolicy.ManualProvision.ProvisionerAssignment.UserProvisioner.AllowReassignment = types.BoolPointerValue(resp.DeprovisionerPolicy.Manual.Assignee.Users.AllowReassignment)
						if resp.DeprovisionerPolicy.Manual.Assignee.Users.UserIds != nil {
							r.DeprovisionerPolicy.ManualProvision.ProvisionerAssignment.UserProvisioner.UserIds = make([]types.String, 0, len(resp.DeprovisionerPolicy.Manual.Assignee.Users.UserIds))
				...
				if resp.DeprovisionerPolicy.Manual.UserIds != nil {
					r.DeprovisionerPolicy.ManualProvision.UserIds = make([]types.String, 0, len(resp.DeprovisionerPolicy.Manual.UserIds))
			...
			if resp.DeprovisionerPolicy.Webhook == nil {
				...
				r.DeprovisionerPolicy.WebhookProvision.WebhookID = types.StringPointerValue(resp.DeprovisionerPolicy.Webhook.WebhookID)
			}
		}
		...
		if resp.ProvisionPolicy == nil {
			...
			r.ProvisionPolicy = &tfTypes.AppEntitlementResourceProvisionPolicy{}
			if resp.ProvisionPolicy.Action == nil {
				r.ProvisionPolicy.ActionProvision = nil
			} else {
				r.ProvisionPolicy.ActionProvision = &tfTypes.ActionProvision{}
				r.ProvisionPolicy.ActionProvision.ActionName = types.StringPointerValue(resp.ProvisionPolicy.Action.ActionName)
				r.ProvisionPolicy.ActionProvision.AppID = types.StringPointerValue(resp.ProvisionPolicy.Action.AppID)
				r.ProvisionPolicy.ActionProvision.ConnectorID = types.StringPointerValue(resp.ProvisionPolicy.Action.ConnectorID)
			}
			if resp.ProvisionPolicy.Connector == nil {
				r.ProvisionPolicy.ConnectorProvision = nil
			} else {
				r.ProvisionPolicy.ConnectorProvision = &tfTypes.AppEntitlementConnectorProvision{}
				if resp.ProvisionPolicy.Connector.Account == nil {
					...
					if resp.ProvisionPolicy.Connector.Account.Config == nil {
						r.ProvisionPolicy.ConnectorProvision.AccountProvision.Config = jsontypes.NewNormalizedNull()
					} else {
						configResult1, _ := json.Marshal(resp.ProvisionPolicy.Connector.Account.Config)
						r.ProvisionPolicy.ConnectorProvision.AccountProvision.Config = jsontypes.NewNormalizedValue(string(configResult1))
					}
					r.ProvisionPolicy.ConnectorProvision.AccountProvision.ConnectorID = types.StringPointerValue(resp.ProvisionPolicy.Connector.Account.ConnectorID)
					if resp.ProvisionPolicy.Connector.Account.DoNotSave == nil {
					...
					if resp.ProvisionPolicy.Connector.Account.SaveToVault == nil {
						...
						if resp.ProvisionPolicy.Connector.Account.SaveToVault.VaultIds != nil {
							r.ProvisionPolicy.ConnectorProvision.AccountProvision.SaveToVault.VaultIds = make([]types.String, 0, len(resp.ProvisionPolicy.Connector.Account.SaveToVault.VaultIds))
							for _, v := range resp.ProvisionPolicy.Connector.Account.SaveToVault.VaultIds {
					...
					r.ProvisionPolicy.ConnectorProvision.AccountProvision.SchemaID = types.StringPointerValue(resp.ProvisionPolicy.Connector.Account.SchemaID)
				}
				if resp.ProvisionPolicy.Connector.DefaultBehavior == nil {
					...
					r.ProvisionPolicy.ConnectorProvision.DefaultBehavior.ConnectorID = types.StringPointerValue(resp.ProvisionPolicy.Connector.DefaultBehavior.ConnectorID)
				}
				if resp.ProvisionPolicy.Connector.DeleteAccount == nil {
					...
					r.ProvisionPolicy.ConnectorProvision.DeleteAccount.ConnectorID = types.StringPointerValue(resp.ProvisionPolicy.Connector.DeleteAccount.ConnectorID)
				}
			}
			if resp.ProvisionPolicy.Delegated == nil {
				r.ProvisionPolicy.DelegatedProvision = nil
			} else {
				r.ProvisionPolicy.DelegatedProvision = &tfTypes.DelegatedProvision{}
				r.ProvisionPolicy.DelegatedProvision.AppID = types.StringPointerValue(resp.ProvisionPolicy.Delegated.AppID)
				r.ProvisionPolicy.DelegatedProvision.EntitlementID = types.StringPointerValue(resp.ProvisionPolicy.Delegated.EntitlementID)
			}
			if resp.ProvisionPolicy.ExternalTicket == nil {
				r.ProvisionPolicy.ExternalTicketProvision = nil
			} else {
				r.ProvisionPolicy.ExternalTicketProvision = &tfTypes.ExternalTicketProvision{}
				r.ProvisionPolicy.ExternalTicketProvision.AppID = types.StringPointerValue(resp.ProvisionPolicy.ExternalTicket.AppID)
				r.ProvisionPolicy.ExternalTicketProvision.ConnectorID = types.StringPointerValue(resp.ProvisionPolicy.ExternalTicket.ConnectorID)
				r.ProvisionPolicy.ExternalTicketProvision.ExternalTicketProvisionerConfigID = types.StringPointerValue(resp.ProvisionPolicy.ExternalTicket.ExternalTicketProvisionerConfigID)
				r.ProvisionPolicy.ExternalTicketProvision.Instructions = types.StringPointerValue(resp.ProvisionPolicy.ExternalTicket.Instructions)
			}
			if resp.ProvisionPolicy.Manual == nil {
				r.ProvisionPolicy.ManualProvision = nil
			} else {
				r.ProvisionPolicy.ManualProvision = &tfTypes.AppEntitlementManualProvision{}
				r.ProvisionPolicy.ManualProvision.Instructions = types.StringPointerValue(resp.ProvisionPolicy.Manual.Instructions)
				if resp.ProvisionPolicy.Manual.Assignee == nil {
					r.ProvisionPolicy.ManualProvision.ProvisionerAssignment = nil
				} else {
					r.ProvisionPolicy.ManualProvision.ProvisionerAssignment = &tfTypes.AppEntitlementProvisionerAssignment{}
					if resp.ProvisionPolicy.Manual.Assignee.AppOwners == nil {
						...
						r.ProvisionPolicy.ManualProvision.ProvisionerAssignment.AppOwnerProvisioner.AllowReassignment = types.BoolPointerValue(resp.ProvisionPolicy.Manual.Assignee.AppOwners.AllowReassignment)
						if resp.ProvisionPolicy.Manual.Assignee.AppOwners.FallbackUserIds != nil {
							r.ProvisionPolicy.ManualProvision.ProvisionerAssignment.AppOwnerProvisioner.FallbackUserIds = make([]types.String, 0, len(resp.ProvisionPolicy.Manual.Assignee.AppOwners.FallbackUserIds))
							for _, v := range resp.ProvisionPolicy.Manual.Assignee.AppOwners.FallbackUserIds {
					...
					if resp.ProvisionPolicy.Manual.Assignee.EntitlementOwners == nil {
						...
						r.ProvisionPolicy.ManualProvision.ProvisionerAssignment.EntitlementOwnerProvisioner.AllowReassignment = types.BoolPointerValue(resp.ProvisionPolicy.Manual.Assignee.EntitlementOwners.AllowReassignment)
						if resp.ProvisionPolicy.Manual.Assignee.EntitlementOwners.FallbackUserIds != nil {
							r.ProvisionPolicy.ManualProvision.ProvisionerAssignment.EntitlementOwnerProvisioner.FallbackUserIds = make([]types.String, 0, len(resp.ProvisionPolicy.Manual.Assignee.EntitlementOwners.FallbackUserIds))
							for _, v := range resp.ProvisionPolicy.Manual.Assignee.EntitlementOwners.FallbackUserIds {
					...
					if resp.ProvisionPolicy.Manual.Assignee.Expression == nil {
						...
						r.ProvisionPolicy.ManualProvision.ProvisionerAssignment.ExpressionProvisioner.AllowReassignment = types.BoolPointerValue(resp.ProvisionPolicy.Manual.Assignee.Expression.AllowReassignment)
						if resp.ProvisionPolicy.Manual.Assignee.Expression.Expressions != nil {
							r.ProvisionPolicy.ManualProvision.ProvisionerAssignment.ExpressionProvisioner.Expressions = make([]types.String, 0, len(resp.ProvisionPolicy.Manual.Assignee.Expression.Expressions))
							for _, v := range resp.ProvisionPolicy.Manual.Assignee.Expression.Expressions {
						...
						if resp.ProvisionPolicy.Manual.Assignee.Expression.FallbackUserIds != nil {
							r.ProvisionPolicy.ManualProvision.ProvisionerAssignment.ExpressionProvisioner.FallbackUserIds = make([]types.String, 0, len(resp.ProvisionPolicy.Manual.Assignee.Expression.FallbackUserIds))
							for _, v := range resp.ProvisionPolicy.Manual.Assignee.Expression.FallbackUserIds {
					...
					if resp.ProvisionPolicy.Manual.Assignee.Group == nil {
						...
						r.ProvisionPolicy.ManualProvision.ProvisionerAssignment.GroupProvisioner.AllowReassignment = types.BoolPointerValue(resp.ProvisionPolicy.Manual.Assignee.Group.AllowReassignment)
						r.ProvisionPolicy.ManualProvision.ProvisionerAssignment.GroupProvisioner.AppGroupID = types.StringPointerValue(resp.ProvisionPolicy.Manual.Assignee.Group.AppGroupID)
						r.ProvisionPolicy.ManualProvision.ProvisionerAssignment.GroupProvisioner.AppID = types.StringPointerValue(resp.ProvisionPolicy.Manual.Assignee.Group.AppID)
						if resp.ProvisionPolicy.Manual.Assignee.Group.FallbackUserIds != nil {
							r.ProvisionPolicy.ManualProvision.ProvisionerAssignment.GroupProvisioner.FallbackUserIds = make([]types.String, 0, len(resp.ProvisionPolicy.Manual.Assignee.Group.FallbackUserIds))
							for _, v := range resp.ProvisionPolicy.Manual.Assignee.Group.FallbackUserIds {
					...
					if resp.ProvisionPolicy.Manual.Assignee.Manager == nil {
						...
						r.ProvisionPolicy.ManualProvision.ProvisionerAssignment.ManagerProvisioner.AllowReassignment = types.BoolPointerValue(resp.ProvisionPolicy.Manual.Assignee.Manager.AllowReassignment)
						if resp.ProvisionPolicy.Manual.Assignee.Manager.FallbackUserIds != nil {
							r.ProvisionPolicy.ManualProvision.ProvisionerAssignment.ManagerProvisioner.FallbackUserIds = make([]types.String, 0, len(resp.ProvisionPolicy.Manual.Assignee.Manager.FallbackUserIds))
							for _, v := range resp.ProvisionPolicy.Manual.Assignee.Manager.FallbackUserIds {
					...
					if resp.ProvisionPolicy.Manual.Assignee.Users == nil {
						...
						r.ProvisionPolicy.ManualProvision.ProvisionerAssignment.UserProvisioner.AllowReassignment = types.BoolPointerValue(resp.ProvisionPolicy.Manual.Assignee.Users.AllowReassignment)
						if resp.ProvisionPolicy.Manual.Assignee.Users.UserIds != nil {
							r.ProvisionPolicy.ManualProvision.ProvisionerAssignment.UserProvisioner.UserIds = make([]types.String, 0, len(resp.ProvisionPolicy.Manual.Assignee.Users.UserIds))
							for _, v := range resp.ProvisionPolicy.Manual.Assignee.Users.UserIds {
				...
				if resp.ProvisionPolicy.Manual.UserIds != nil {
					r.ProvisionPolicy.ManualProvision.UserIds = make([]types.String, 0, len(resp.ProvisionPolicy.Manual.UserIds))
					for _, v := range resp.ProvisionPolicy.Manual.UserIds {
