...
func (r *AppEntitlementMonitorBindingDataSourceModel) RefreshFromSharedAppEntitlementMonitorBinding(ctx context.Context, resp *shared.AppEntitlementMonitorBinding) diag.Diagnostics {
...
func (r *AppEntitlementMonitorBindingDataSourceModel) ToSharedGetAppEntitlementMonitorBindingRequest(ctx context.Context) (*shared.GetAppEntitlementMonitorBindingRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
